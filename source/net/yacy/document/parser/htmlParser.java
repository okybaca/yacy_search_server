...
>>>>>>> 4a6cc133c (Improved heuristics to store the published date into last_modified)
=======
            final Document document = transformScraper(location, mimeType, detectedcharsetcontainer[0].name(), scraper);
>>>>>>> 051cc4bc8 (Revert "Improved heuristics to store the published date into last_modified")
